<template>
  ...
  <vee-form :validation-schema="schema" @submit="register" :initial-values="userData">
    ...
    <div class="mb-3">
      ...
      <vee-field name="password" :bails="false" v-slot="{ field, errors }">
        <input class="block w-full py-1.5 px-3 text-gray-800 border
          ...
          focus:border-black rounded" type="password" placeholder="Password" v-bind="field" />
    ...
    <!-- TOS -->
    <div class="mb-3 pl-6">
      <vee-field type="checkbox" name="tos" value="1" class="w-4 h-4 float-left -ml-6 mt-1 rounded inline-block" />
